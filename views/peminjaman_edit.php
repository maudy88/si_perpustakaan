                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="nope" class="col-sm-3 control-label">Nomor Buku</label>
                             <div class="col-sm-9">
								<input type="text" name="nope" value="<?=$data['no_buku']?>"class="form-control" id="inputEmail3" placeholder="Nomor Perkara" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
...
if($_POST){
    ...
    $ket=$_POST['ket'];
    //buat sql
    $sql="UPDATE peminjaman SET no_buku = '$nope', peminjam='$peminjam', tgl_pinjam='$tglPinjam', tgl_kembali='$tglKembali', lama_pinjam='$lamapinjam',
