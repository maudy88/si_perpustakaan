...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE peminjaman SET tgl_kembali='$tglKembali', lama_pinjam='$lamapinjam' WHERE id='$id'";
	$sqlBuku="UPDATE tbl_buku SET status='Ada' WHERE id='$id'";
    $query=  mysqli_query($koneksi, $sql) or die ("SQL Simpan Buku Error");
	$queryArsip=  mysqli_query($koneksi, $sqlBuku) or die ("SQL Simpan Buku Error");
    if ($query){
